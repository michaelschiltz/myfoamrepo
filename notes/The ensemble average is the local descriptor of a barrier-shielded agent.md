...
So economics is the self-description of a civilization that engineered barrier-absorbing institutions until the ensemble average became *locally true* for the individual agent — and then mistook a manufactured, institution-dependent condition for a law of nature. This is a thesis with a mechanism: EE supplies the dynamics, [[Entity-shielding]] supplies the channel by which the dynamics get altered.
...
Ensemble vs time-average session — the load-bearing sentence fusing EE and entity-shielding.
