...
> **Stub** — resolves the placeholder referenced across the ergodicity notes. Develop with the Birkhoff–Khinchin equivalence conditions (see [[Route Kolmogorov to ergodic theory not the theory of means]]).
