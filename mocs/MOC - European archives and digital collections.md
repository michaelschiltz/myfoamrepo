...
**The European survey is complete.** Non-European repositories — Ottoman, Geniza, Japanese, South and East Asian — are named in the grant's travel line and need their own pass; see [[Handoff - the non-European archive survey]]. **The non-European survey is complete**: [[MOC - Ottoman archives]], [[MOC - Geniza archives]], [[MOC - Japanese archives]], [[MOC - Chinese archives]], [[MOC - South Asian archives]], which hang off the table above. **South-East Asia was not surveyed as a region** — see Decision_log D4 and the note in the South Asian hub.
