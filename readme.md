...
After setting up the repository, head to [getting started](mynotes/getting-started.md) to get familiar with your new knowledge base!
...
- [getting-started](mynotes/getting-started.md) - learn how to use your Foam workspace
